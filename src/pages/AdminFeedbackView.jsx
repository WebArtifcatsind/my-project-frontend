...
const AdminFeedbackView = () => {
  ...
  const fetchFeedbacks = async () => {
    try {
      const res = await axios.get("https://api.webartifacts.in/api/client/feedbacks", {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://api.webartifacts.in/api/client/feedback/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const markPublic = async (id) => {
    try {
      await axios.put(
        `https://api.webartifacts.in/api/client/feedback/public/${id}`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleUnmarkPublic = async (id) => {
    try {
      await axios.put(
        `https://api.webartifacts.in/api/client/feedback/unpublic/${id}`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
