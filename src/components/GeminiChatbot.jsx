...
import { MessageSquare, Minus, RefreshCcw } from 'lucide-react'; // Added Minus and RefreshCcw icons
...
  // Function to refresh the chatbot (clear chat history)
...
          <h2 className="gemini-chatbot-title">WebArtifacts</h2>
          <div className="gemini-chatbot-actions">
            <button className="gemini-chatbot-action-button" onClick={refreshChatbot} aria-label="Refresh Chat">
              <RefreshCcw size={18} />
            </button>
            <button className="gemini-chatbot-action-button" onClick={toggleChatbox} aria-label="Minimize Chat">
              <Minus size={18} />
            </button>
          </div>
        </div>
